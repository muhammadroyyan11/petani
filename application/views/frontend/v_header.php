...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      ...
      <!-- <button class="button-scan">tes</button> -->

      <button class="navbar-toggler collapsed h" type="button" data-toggle="collapse" data-target="#navbarDefault"
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('scan'); ?>">Scan</a>
          </li>
          <li class="nav-item">
